            ...
            <BrowserRouter>
                <Routes>
                    <Route element={<Layout />}>
                        ...
                        <Route
                            path="works/TenthPlanet"
                            element={<TenthPlanetProjectPage />}
                        />
                        <Route
                            path="works/InnerChildLiving"
                            element={<InnerChildLivingProjectPage />}
                        />
                        <Route
                            path="works/MonsoonFN"
                            element={<MonsoonFNProjectPage />}
                        />
                        <Route
                            path="works/SacredSpaces"
                            element={<SacredSpacesProjectPage />}
                        />
                        <Route
                            path="works/Fractured"
                            element={<FracturedProjectPage />}
                        />
                        <Route
                            path="works/Chris&Chamilla"
                            element={<ChrisChamillaProjectPage />}
                        />
